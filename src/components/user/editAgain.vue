	...
	<div class="shift">
		...
		<el-form :model="ruleForm" style="margin-top: 2%;" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
			<el-form-item label="课程分类" style="text-align: left;">
				<el-select v-model="ruleForm.firstID" placeholder="分类" @change="firstCate" @visible-change="firstCategories">
			...
			<el-form-item label="课程价格" prop="courseFree" style="text-align: left;">
				<el-radio-group v-model="ruleForm.courseFree">
					<el-radio label="免费" style="float: left;"></el-radio>
					<el-radio label="收费" disabled style="float: left;"></el-radio>
			...
			<el-form-item label="权限设置" prop="visibleRange" style="text-align: left;">
				...
				<el-radio-group v-model="ruleForm.visibleRange">
					...
					<el-radio label="部分可见" @change="visibles"></el-radio>
				</el-radio-group>

				<el-checkbox-group v-model="ruleForm.userId" v-if="ruleForm.visibleRange == '部分可见'">
...
//			}
		...
		methods: {
			editCourse(){
//				this.$api.CourseApi.editCourse(this.$route.params.id,result => {
				this.$api.CourseApi.editCourse(45,result => {
					console.log(result)
...
//			下一步
			submitForm(formName) {
				this.$refs[formName].validate((valid) => {
					if(valid) {
						if(this.ruleForm.courseFree == "免费"){
							this.ruleForm.courseFree = 1
						}else{
							this.ruleForm.courseFree = 2
						}
						if(this.ruleForm.visibleRange == '全部可见'){
