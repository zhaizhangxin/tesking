<template>
		...
		<el-main style="margin-top: 2%;">
			<el-header class="cert" style="border-bottom: 1px solid #E0E0DD;">
				<el-row :gutter="20">
					<el-col :span="10" style="text-align: left;">
						<span class="grid-content" style="font-size: 16px;">系统公告</span>
					...
					<el-col :span="14" style="text-align: right;">
						...
						<el-button type="primary" @click="tableEdits = true">新增公告</el-button>
			...
			<el-main style="background-color: #FFFFFF;margin-top: 20px;" class="cert">
				<el-table :data="tableData" border style="width: 100%">
					...
					<el-table-column label="操作" align="center">
						<template slot-scope="scope">
							...
							<el-button type="text" size="small" style="color: #001380;">置顶</el-button>
